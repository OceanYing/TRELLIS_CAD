## fork from TRELLIS (2025/05/30): https://github.com/microsoft/TRELLIS/commit/f17fdf12d8f17a6a09225f01756d141285dc848f

### features:
* My installation (setup.sh): flash-attn, kaolin
* Batch inference & local pretrained model path (example.py)
* Disable .github/workflows/CodeQL (from orig repo): it reports autobuild error all the time

### TODO:
* Learn the code structure
* Train for more iterations
* Finetune based on existing ckpts
