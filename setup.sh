...
# go to https://github.com/Dao-AILab/flash-attention/releases/ and find the version that is suitable to your pytorch-cuda version
# wget https://github.com/Dao-AILab/flash-attention/releases/download/v2.7.3/flash_attn-2.7.3+cu11torch2.4cxx11abiTRUE-cp310-cp310-linux_x86_64.whl
# pip install flash_attn-2.7.3+cu11torch2.4cxx11abiTRUE-cp310-cp310-linux_x86_64.whl
...
# fi
### NOTE: Haiyang
### Pre-built Kaolin are built on GLIB_C=2.29
### If no GLIB_C 2.29 exists (nexus only has GLIB_C=2.28): you need to build from source
